...
class _TelemetryScreenState extends State<TelemetryScreen> {
  ...
  Future<void> _autoSendTick() async {
    if (!isAutoSending || isSending) return;
  ...
  void _startAutoSend() {
    ...
    setState(() {
      isAutoSending = true;
      statusMessage = 'Auto-sending location every 5 seconds';
    });
  ...
  void _stopAutoSend() {
    ...
    setState(() {
      isAutoSending = false;
      statusMessage = 'Auto-send stopped';
    });
  }
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              width: double.infinity,
              child: ElevatedButton.icon(
                onPressed: (isAutoSending || isLoadingLocation) ? null : _startAutoSend,
                icon: isAutoSending
                    ? const SizedBox(
                        width: 20,
                        height: 20,
                ...
                label: Text(isAutoSending ? 'Auto Sending...' : 'Send Location'),
                style: ElevatedButton.styleFrom(
            ...
            SizedBox(
              ...
              child: OutlinedButton.icon(
                ...
                label: const Text('Stop Auto Send'),
