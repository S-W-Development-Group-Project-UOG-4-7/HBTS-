...
app.use("/api/operator", operatorBusesRoutes);
app.use("/api/operator", operatorDriversRoutes);
app.use("/api/operator", operatorTripsRoutes);
app.use("/api/operator", operatorRoutesRoutes);
app.use("/api/operator", operatorConductorsRoutes);
app.use("/api/operator", platformAllocationRoutes);
app.use("/api/operator", ticketValidationRoutes);
